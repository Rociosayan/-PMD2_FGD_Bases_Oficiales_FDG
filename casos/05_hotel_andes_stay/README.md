...
| `clientes` | Huéspedes — incluye PII y el dato sensible `nacionalidad`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/05_hotel_andes_stay/05_hotel_andes_stay.db"
