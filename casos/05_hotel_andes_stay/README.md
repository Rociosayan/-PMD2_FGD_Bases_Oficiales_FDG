...
**Sector:** Turismo y hotelería  |  **Código del caso:** `05_hotel_andes_stay`

## Contexto
Hotel Andes Stay es una cadena hotelera boutique con sedes en Miraflores y Cusco. Registra a sus huéspedes, su personal,
su catálogo de habitaciones y servicios, las operaciones del negocio, los pagos y las incidencias.
La dirección necesita **ordenar, auditar y gobernar** estos datos (semanas 9 a 15 del curso).

## Archivos
- `05_hotel_andes_stay.db` — base SQLite oficial del caso.
...
| `clientes` | Huéspedes — incluye datos personales y el dato personal de nacionalidad `nacionalidad`. |
| `productos_servicios` | Catálogo de habitaciones y servicios. |
...
caso = "05_hotel_andes_stay"
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/05_hotel_andes_stay/05_hotel_andes_stay.db"
