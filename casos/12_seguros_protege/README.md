...
| `clientes` | Asegurados — incluye datos personales y el dato confidencial financiero `monto_asegurado`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/12_seguros_protege/12_seguros_protege.db"
