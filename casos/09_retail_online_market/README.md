...
**Sector:** E-commerce  |  **Código del caso:** `09_retail_online_market`

## Contexto
Retail Online Market es una tienda online con reparto a todo Lima Metropolitana. Registra a sus clientes, su personal,
su catálogo de productos, las operaciones del negocio, los pagos y las incidencias.
La dirección necesita **ordenar, auditar y gobernar** estos datos (semanas 9 a 15 del curso).

## Archivos
- `09_retail_online_market.db` — base SQLite oficial del caso.
...
| `clientes` | Clientes — incluye datos personales y el dato confidencial financiero `tarjeta_terminacion`. |
...
caso = "09_retail_online_market"
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/09_retail_online_market/09_retail_online_market.db"
