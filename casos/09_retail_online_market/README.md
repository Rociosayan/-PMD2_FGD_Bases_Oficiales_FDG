...
| `clientes` | Clientes — incluye PII y el dato sensible `tarjeta_terminacion`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/09_retail_online_market/09_retail_online_market.db"
