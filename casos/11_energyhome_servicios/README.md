# EnergyHome Servicios

**Sector:** Servicios de energía  |  **Código del caso:** `11_energyhome_servicios`

## Contexto
EnergyHome Servicios es una empresa de servicios de energía domiciliaria en Lima Sur. Registra a sus clientes, su personal,
...
## Archivos
- `11_energyhome_servicios.db` — base SQLite oficial del caso.
...
| `clientes` | Clientes — incluye datos personales y el dato confidencial de consumo `consumo_kwh`. |
...
caso = "11_energyhome_servicios"
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/11_energyhome_servicios/11_energyhome_servicios.db"
