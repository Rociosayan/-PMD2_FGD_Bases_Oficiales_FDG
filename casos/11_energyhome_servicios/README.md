...
| `clientes` | Clientes — incluye PII y el dato sensible `consumo_kwh`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/11_energyhome_servicios/11_energyhome_servicios.db"
