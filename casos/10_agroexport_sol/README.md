...
| `clientes` | Clientes — incluye PII y el dato sensible `pais_destino`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/10_agroexport_sol/10_agroexport_sol.db"
