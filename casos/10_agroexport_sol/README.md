...
**Sector:** Agroexportación  |  **Código del caso:** `10_agroexport_sol`

## Contexto
AgroExport Sol es una empresa agroexportadora del norte con campos en Ica y La Libertad. Registra a sus clientes, su personal,
su catálogo de productos agrícolas, las operaciones del negocio, los pagos y las incidencias.
La dirección necesita **ordenar, auditar y gobernar** estos datos (semanas 9 a 15 del curso).

## Archivos
- `10_agroexport_sol.db` — base SQLite oficial del caso.
...
| `clientes` | Clientes — incluye datos personales y el dato comercial contextual `pais_destino`. |
| `productos_servicios` | Catálogo de productos agrícolas. |
...
caso = "10_agroexport_sol"
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/10_agroexport_sol/10_agroexport_sol.db"
