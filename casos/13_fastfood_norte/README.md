...
| `clientes` | Clientes — incluye PII y el dato sensible `direccion_delivery`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/13_fastfood_norte/13_fastfood_norte.db"
