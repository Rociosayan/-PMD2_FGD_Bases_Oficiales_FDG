...
**Sector:** Alimentos y bebidas  |  **Código del caso:** `13_fastfood_norte`

## Contexto
FastFood Norte es una cadena de comida rápida con locales en Lima Norte. Registra a sus clientes, su personal,
su catálogo de productos de menú, las operaciones del negocio, los pagos y las incidencias.
La dirección necesita **ordenar, auditar y gobernar** estos datos (semanas 9 a 15 del curso).

## Archivos
- `13_fastfood_norte.db` — base SQLite oficial del caso.
...
| `clientes` | Clientes — incluye datos personales y el dato personal restringido de entrega `direccion_delivery`. |
| `productos_servicios` | Catálogo de productos de menú. |
...
caso = "13_fastfood_norte"
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/13_fastfood_norte/13_fastfood_norte.db"
