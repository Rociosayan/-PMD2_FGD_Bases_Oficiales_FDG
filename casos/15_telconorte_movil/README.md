...
| `clientes` | Abonados — incluye PII y el dato sensible `numero_linea`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/15_telconorte_movil/15_telconorte_movil.db"
