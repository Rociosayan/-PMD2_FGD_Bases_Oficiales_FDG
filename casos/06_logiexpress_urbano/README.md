...
| `clientes` | Clientes — incluye PII y el dato sensible `direccion_entrega`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/06_logiexpress_urbano/06_logiexpress_urbano.db"
