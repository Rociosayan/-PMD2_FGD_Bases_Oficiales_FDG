...
**Sector:** Logística y reparto  |  **Código del caso:** `06_logiexpress_urbano`

## Contexto
LogiExpress Urbano es una operador de última milla con centros de distribución en Lima. Registra a sus clientes, su personal,
su catálogo de servicios de envío, las operaciones del negocio, los pagos y las incidencias.
...
| `clientes` | Clientes — incluye datos personales y el dato personal restringido de entrega `direccion_entrega`. |
| `productos_servicios` | Catálogo de servicios de envío. |
...
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/06_logiexpress_urbano/06_logiexpress_urbano.db"
