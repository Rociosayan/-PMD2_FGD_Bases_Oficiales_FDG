...
| `clientes` | Clientes — incluye PII y el dato sensible `condicion_cronica`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/03_farmacia_medisur/03_farmacia_medisur.db"
