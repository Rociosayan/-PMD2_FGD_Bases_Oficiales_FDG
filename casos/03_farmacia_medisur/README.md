...
**Sector:** Retail farmacéutico  |  **Código del caso:** `03_farmacia_medisur`

## Contexto
Farmacia MediSur es una cadena de boticas con locales en conos de Lima. Registra a sus clientes, su personal,
su catálogo de medicamentos y productos, las operaciones del negocio, los pagos y las incidencias.
La dirección necesita **ordenar, auditar y gobernar** estos datos (semanas 9 a 15 del curso).

## Archivos
- `03_farmacia_medisur.db` — base SQLite oficial del caso.
...
| `clientes` | Clientes — incluye datos personales y el dato sensible de salud `condicion_cronica`. |
| `productos_servicios` | Catálogo de medicamentos y productos. |
...
caso = "03_farmacia_medisur"
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/03_farmacia_medisur/03_farmacia_medisur.db"
