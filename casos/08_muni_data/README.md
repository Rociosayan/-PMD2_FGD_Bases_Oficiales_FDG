...
| `clientes` | Ciudadanos — incluye datos personales y el dato personal contextual del trámite `tipo_tramite`. |
...
caso = "08_muni_data"
url = "https://raw.githubusercontent.com/Rociosayan/PMD2_FDG_Casos/main/casos/08_muni_data/08_muni_data.db"
