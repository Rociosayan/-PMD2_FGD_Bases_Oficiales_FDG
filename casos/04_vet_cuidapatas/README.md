...
| `clientes` | Clientes — incluye PII y el dato sensible `motivo_atencion_mascota`. |
...
url = "https://raw.githubusercontent.com/Rociosayan/-PMD2_FGD_Bases_Oficiales_FDG/main/casos/04_vet_cuidapatas/04_vet_cuidapatas.db"
